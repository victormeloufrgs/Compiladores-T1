...
void semantic_verification(AST* ast_tree) {
    set_scope(ast_tree);
    check_and_set_declarations(ast_tree);
    check_vet_indexes(ast_tree);
    check_var_vet_func_use(ast_tree);
    check_undeclared();
    check_operands(ast_tree);
}
